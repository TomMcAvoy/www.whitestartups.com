...
public class SecurityConfig {
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(authorize -> 
                authorize
                    .requestMatchers("/actuator/**", "/logout").permitAll()
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient client1 = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://localhost:8080/login/oauth2/code/whitestartups")
                ...
                .clientSettings(ClientSettings.builder()
                    .requireAuthorizationConsent(false)  // Internal trusted client
                    .build())
                .build();
        ...
        RegisteredClient client2 = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
                .authorizationGrantType(AuthorizationGrantType.CLIENT_CREDENTIALS)
                .redirectUri("http://localhost:8081/login/oauth2/code/whitestartups")
                ...
                .scope("write")
                .clientSettings(ClientSettings.builder()
                    .requireAuthorizationConsent(true)   // External client requires consent
                    .build())
                .build();
